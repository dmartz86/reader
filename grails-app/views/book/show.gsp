	...
	<body>
		...
		<div id="show-book" class="content scaffold-show" role="main">
			...
			<ol class="property-list book">
				...
				<g:if test="${bookInstance?.country}">
				<li class="fieldcontain">
					<span id="country-label" class="property-label"><g:message code="book.country.label" default="Country" /></span>
					
						<span class="property-value" aria-labelledby="country-label"><g:fieldValue bean="${bookInstance}" field="country"/></span>
